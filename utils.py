...
def get_args():
    ...
    parser.add_argument('--tabtrain', action='store_false', default=True, help='Enable tabtrain')
    parser.add_argument('--ctrain', action='store_true', default=False, help='Enable controlnettrain')
    #parser.add_argument('--tabtrain', type = bool, default=True)
    #parser.add_argument('--ctrain', type = bool, default=False)
