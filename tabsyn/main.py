...
from controlnet.utils import tensor_add_laplace_noise
...
def main(args): 
    ...
    trainable_params = sum(p.numel() for p in denoise_fn.parameters() if p.requires_grad)
    print(f'number of parameters of controlnet is {trainable_params}')
